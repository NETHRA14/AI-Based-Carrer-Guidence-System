        ...
        <div className="py-16">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span>nethrapudur@gmail.com</span>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, x: -20 }}
                  whileInView={{ opacity: 1, x: 0 }}
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              >
                <span className="text-gray-300 text-sm whitespace-nowrap">Stay updated:</span>
                <div className="flex">
                  <input
                    type="email"
                    ...
                    className="px-4 py-2 bg-glass-bg border border-glass-border rounded-l-lg text-white placeholder-gray-400 focus:outline-none focus:border-neon-cyan transition-colors duration-300 w-52"
                  />
                  <motion.button
                ...
                <AnimatePresence>
                  {subscribed && (
                    <motion.div
                      ...
                      className="absolute -top-14 right-0 flex items-center gap-2 bg-green-500/20 border border-green-500/40 text-green-400 text-sm font-semibold px-4 py-2.5 rounded-xl shadow-lg backdrop-blur-sm"
                    >
                      <span>✅</span>
                      <span>Done! Successfully Subscribed 🎉</span>
                    </motion.div>
                  )}
                </AnimatePresence>
              </motion.div>
