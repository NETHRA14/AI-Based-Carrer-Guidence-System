  ...
  const allTeamMembers = [
    {
      ...
      profileImage: '/Nethra.jpg',
      icon: Code,
      color: 'text-neon-cyan',
      isLeader: true,
      email: 'nethrapudur@gmail.com',
      phone: '+91 7010178967',
      social: {
        ...
        github: 'https://github.com/Nethra14'
      }
    },
    {
      name: 'Keerthana Sri S',
    ...
    {
      name: 'Rithikasri ',
      role: 'Frontend and Database Lead',
            ...
            {allTeamMembers.map((member, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className={`glass-card p-8 rounded-2xl text-center hover:scale-105 transition-transform duration-300 relative ${member.isLeader ? 'border-2 border-neon-cyan/50' : ''
                    }`}
                >
                  {/* Leader Badge */}
                  {member.isLeader && (
                  ...
                  <div className="mb-6">
                    <div className={`w-24 h-24 rounded-full bg-gradient-to-br from-neon-cyan to-neon-pink p-1 mx-auto mb-4 ${member.isLeader ? 'w-28 h-28' : ''
                      }`}>
