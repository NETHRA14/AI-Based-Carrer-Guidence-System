...
export default function PricingPage() {
  ...
  const handleSubscribe = (tierId: string) => {
    ...
    // Navigate to our custom payment page instead of Stripe
    const billing = billingCycle === 'quarterly' ? 'annual' : 'monthly'
    router.push(`/payment?tier=${tierId}&billing=${billing}`)
  }
