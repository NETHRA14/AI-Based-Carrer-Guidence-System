                ...
                <div className="mt-8 pt-6 border-t border-glass-border">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-gray-300">nethrapudur@gmail.com</span>
                      <button
                        onClick={() => copyToClipboard('nethrapudur@gmail.com')}
                        className="p-1 hover:bg-white/10 rounded"
                      >
                        {copiedText === 'nethrapudur@gmail.com' ? (
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-gray-300">Phone: +91 7010178967</span>
                      <button
                        onClick={() => copyToClipboard('+91 7010178967')}
                        className="p-1 hover:bg-white/10 rounded"
                      >
                        {copiedText === '+91 7010178967' ? (
                          <Check className="h-4 w-4 text-green-400" />
                        ) : (
                          <Copy className="h-4 w-4 text-gray-400" />
                        )}
      ...
      <section className="relative z-10 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.a
              href="mailto:nethrapudur@gmail.com"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
