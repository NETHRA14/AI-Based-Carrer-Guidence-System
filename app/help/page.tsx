                  ...
                  {helpCategories.map((category, index) => {
                    ...
                    return (
                      <motion.button
                        ...
                        className={`w-full text-left p-4 rounded-lg transition-colors duration-300 flex items-center space-x-3 ${activeCategory === category.name
                            ? 'bg-neon-cyan/10 border border-neon-cyan/20'
                            : 'hover:bg-white/5'
                          }`}
                      >
                        <IconComponent className={`h-5 w-5 ${activeCategory === category.name ? 'text-neon-cyan' : 'text-gray-400'
                          }`} />
                        <div className="flex-1">
                          <span className={`font-semibold ${activeCategory === category.name ? 'text-neon-cyan' : 'text-white'
                            }`}>
                            {category.name}
                          </span>
